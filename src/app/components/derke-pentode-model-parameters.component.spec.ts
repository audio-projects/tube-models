...
describe('DerkEPentodeModelParametersComponent', () => {
    let component: DerkEPentodeModelParametersComponent;
    let fixture: ComponentFixture<DerkEPentodeModelParametersComponent>;
    ...
    const mockDerkEModelParameters = {
        mu: 70,
        ex: 1.5,
        kg1: 800,
        kg2: 400,
    ...
    beforeEach(async () => {
        ...
        await TestBed.configureTestingModule({
            imports: [DerkEPentodeModelParametersComponent],
            providers: [
        ...
        fixture = TestBed.createComponent(DerkEPentodeModelParametersComponent);
    ...
    describe('Calculated state (with parameters)', () => {
        beforeEach(() => {
            ...
            component.tube = {
                ...mockTube,
                derkEModelParameters: { ...mockDerkEModelParameters }
            };
            component.isCalculating = false;
            component.canCalculate = true;

            modelService.getDerkEModel.and.returnValue({
                name: 'EF80_DERKE',
                model: '.subckt EF80_DERKE P G2 G1 K\nG1 G1 K VALUE={PWR(V(P,K)/KP,EX) + V(G1,K)/MU}\nE1 1 0 VALUE={V(G1,K)/KG1*LOG(1+EXP(KG1*V(G1)))}\nRE1 1 0 1G\nGP P K VALUE={V(1)/KVB*ATAN(V(P,K)/KVB)}\n.ends'
            });
            modelService.getDerkEModelDefinition.and.returnValue('.param KP=500 MU=70 EX=1.5 KG1=800 KG2=400 KVB=250 A=0.5');
        ...
        it('should display SPICE model code', () => {
            ...
            expect(preElement.nativeElement.textContent).toContain('.subckt EF80_DERKE');
        });
    ...
    describe('resetParameters()', () => {
        it('should delete derkEModelParameters from tube', () => {
            // arrange
            component.tube = {
                ...mockTube,
                derkEModelParameters: { ...mockDerkEModelParameters }
            ...
            // assert
            expect(component.tube.derkEModelParameters).toBeUndefined();
        });
        ...
        it('should handle tube without derkEModelParameters', () => {
            // arrange
            component.tube = { ...mockTube };
        ...
        it('should trigger UI update after reset', () => {
            ...
            modelService.getDerkEModelDefinition.and.returnValue('.param KP=500 MU=70');
            ...
            modelService.getDerkEModelDefinition.and.returnValue('');
    ...
    describe('spiceModel getter', () => {
        ...
        it('should call modelService.getDerkEModel with tube', () => {
            // act
            void component.spiceModel;

            // assert
            expect(modelService.getDerkEModel).toHaveBeenCalledWith(component.tube);
        });

        it('should call modelService.getDerkEModelDefinition with secondary emission flag', () => {
            // act
            void component.spiceModel;

            // assert
            expect(modelService.getDerkEModelDefinition).toHaveBeenCalledWith(true);
        });

        it('should pass false to getDerkEModelDefinition when secondary emission is disabled', () => {
            // arrange
            component.tube = {
                ...mockTube,
                derkEModelParameters: {
                    ...mockDerkEModelParameters,
            ...
            // assert
            expect(modelService.getDerkEModelDefinition).toHaveBeenCalledWith(false);
        });
        ...
        it('should combine model and definition with double newline separator', () => {
            ...
            // assert
            expect(result).toBe('.subckt EF80_DERKE P G2 G1 K\n...\n.ends\n\n.param KP=500 MU=70');
        });
    ...
    describe('secondaryEmission getter/setter', () => {
        ...
        it('should return false when tube has no derkEModelParameters', () => {
            // act
        ...
        it('should return false when derkEModelParameters exists but secondaryEmission is not set', () => {
            // arrange
            component.tube = {
                ...mockTube,
                derkEModelParameters: {}
        ...
        it('should set secondaryEmission to true', () => {
            ...
            // assert
            expect(component.tube?.derkEModelParameters?.secondaryEmission).toBe(true);
        });
        ...
        it('should set secondaryEmission to false', () => {
            ...
            // assert
            expect(component.tube?.derkEModelParameters?.secondaryEmission).toBe(false);
        });

        it('should create derkEModelParameters object if it does not exist', () => {
            // act
            component.secondaryEmission = true;

            // assert
            expect(component.tube?.derkEModelParameters).toBeDefined();
            expect(component.tube?.derkEModelParameters?.secondaryEmission).toBe(true);
        });
    ...
    describe('onSecondaryEmissionChange()', () => {
        ...
        it('should update secondaryEmission when checkbox is unchecked', () => {
            ...
            component.tube = {
                ...mockTube,
                derkEModelParameters: { secondaryEmission: true }
            };
            const event = {
        ...
        it('should invalidate calculatedOn when checkbox changes and parameters exist', () => {
            ...
            // assert
            expect(component.tube?.derkEModelParameters?.calculatedOn).toBeUndefined();
        });

        it('should not throw when derkEModelParameters does not exist', () => {
            // arrange
            const event = {
                target: { checked: true } as HTMLInputElement
            } as unknown as Event;
        ...
        it('should create derkEModelParameters if it does not exist when checkbox is changed', () => {
            // arrange
            const event = {
                target: { checked: true } as HTMLInputElement
            } as unknown as Event;
    ...
    describe('Edge cases', () => {
        it('should handle tube with null derkEModelParameters', () => {
            // arrange
            component.tube = {
                ...mockTube,
        ...
        it('should handle tube with derkEModelParameters but no calculatedOn', () => {
            // arrange
            component.tube = {
                ...mockTube,
                derkEModelParameters: {
        ...
        it('should handle both isCalculating and tube.derkEModelParameters (calculating should take precedence)', () => {
            // arrange
            component.tube = {
                ...mockTube,
                derkEModelParameters: { ...mockDerkEModelParameters }
