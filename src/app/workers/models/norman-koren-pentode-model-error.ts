...
export const normanKorenPentodeModelError = function (files: File[], mu: number, kp: number, kvb: number, ex: number, kg1: number, kg2: number, maximumPlateDissipation: number) {
    // result
    let r = 0;
    // loop data files
