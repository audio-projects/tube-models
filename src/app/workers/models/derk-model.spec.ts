...
describe('models / derkModel', () => {
    ...
    it('should calculate ip and is correctly with valid inputs', () => {
        ...
        const w = 0.01;
        // act
        const result: PentodeModelResult = derkModel(ep, eg, es, kp, mu, kvb, ex, kg1, kg2, a, alpha, alphaS, beta, secondaryEmission, s, alphaP, lambda, v, w);
        // assert
    ...
    it('should calculate alpha correctly when not provided', () => {
        // arrange
        const ep = 100;
        const eg = 50;
        const es = 20;
