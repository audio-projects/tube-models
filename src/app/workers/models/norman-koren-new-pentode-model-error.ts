...
export const normanKorenNewPentodeModelError = function (files: File[], kp: number, mu: number, kvb: number, ex: number, kg1: number, kg2: number): {sse: number, rmse: number} {
    // result
    let error = 0;
    let count = 0;
    // loop data files
